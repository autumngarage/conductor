...
`--max-iterations <n>` is an exec-only Conductor-managed tool-use loop cap. If unset, it defaults from base 10 by effective `--effort`: unset/minimal=10, low=15, medium=20, high=80, max=100.
